...
# Description
This is a Chip 8 emulator (interpreter) made with C++. Window graphics, user input, and sound are all handled with SDL, with OpenGL used for the video renderer. As of now, there is only support for basic Chip 8.
